        ...
        <div className='px-20'>
           ...
           <div className='section-bg flex gap-3  py-8 justify-center '>
                <div className='h-full w-[22%] cursor-pointer group overflow-hidden rounded-[50px]'>
                    <img src="/public/images/wedding/wed1.jpeg" className='w-full rounded-[50px] object-cover group-hover:scale-105 duration-300 transition-all ease-in' alt="wedding 1" />
                </div>
                <div className='h-full w-[15%] cursor-pointer group overflow-hidden rounded-[50px]'>
                    <img src="/public/images/wedding/wed2.jpeg" className="w-full h-[15.6rem] rounded-[50px] object-cover group-hover:scale-105 duration-300 transition-all ease-in" alt="wedding 2" />
                </div>
                <div className='h-full cursor-pointer group overflow-hidden rounded-[50px] w-[23%]'>
                    <img src="/public/images/wedding/sed3.jpeg" 
                ...
                <div className='h-full cursor-pointer group overflow-hidden rounded-[50px] w-[23%]'>
                    <img src="/public/images/wedding/wed4.jpeg" 
                ...
                <div className='h-full cursor-pointer group overflow-hidden rounded-[50px] w-[15%]'>
                    <img src="/public/images/wedding/wed5.jpeg" 
